...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Node.price_fragment'
        db.alter_column('catalog_node', 'price_fragment', self.gf('jimi.price.fields.MoneyField')(max_length=21))

    def backwards(self, orm):

        # Changing field 'Node.price_fragment'
        db.alter_column('catalog_node', 'price_fragment', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2))
